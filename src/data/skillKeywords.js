...
export const skillKeywords = {
  ...
  // Added 2026-08-21 alongside the 40 new skills merged in from the
  // Skills & Subskills PDFs (see docs/CONTEXT.md).
  "client-server-architecture": ["client-server", "request-response architecture", "stateless server", "service boundaries"],
  caching: ["caching", "cache-aside", "write-through cache", "write-back cache", "cache invalidation", "eviction policy", "cache stampede"],
  "lru-cache": ["lru cache", "least recently used", "lru"],
  "ttl-caching": ["ttl", "time to live", "cache expiration"],
  "performance-engineering": ["performance engineering", "latency", "throughput", "profiling", "benchmarking", "capacity planning"],
  debugging: ["debugging", "root-cause analysis", "root cause analysis", "production debugging"],
  pgvector: ["pgvector", "vector embeddings", "vector similarity", "vector index"],
  hypopg: ["hypopg", "hypothetical index"],
  hikaricp: ["hikaricp", "connection pooling", "connection pool"],
  "distributed-systems": ["distributed systems", "cap theorem", "consistent hashing", "distributed transactions", "circuit breaker", "service discovery"],
  tokio: ["tokio", "async runtime", "rust async"],
  "protocol-buffers": ["protocol buffers", "protobuf", "schema evolution"],
  keycloak: ["keycloak", "identity and access management", "realm", "role-based authorization"],
  "openid-connect-oidc": ["openid connect", "oidc", "pkce", "id token", "authorization code flow"],
  clickhouse: ["clickhouse", "columnar storage", "olap"],
  nginx: ["nginx", "reverse proxy", "load balancing", "static file serving"],
  opentelemetry: ["opentelemetry", "distributed tracing", "spans", "trace context", "instrumentation"],
  "inverted-index": ["inverted index", "postings list", "term frequency", "document frequency", "boolean retrieval"],
  leb128: ["leb128", "variable-length integer encoding", "delta encoding"],
  "convolutional-neural-networks-cnns": ["convolutional neural network", "cnn", "feature map", "receptive field", "pooling layer"],
  lime: ["lime", "model interpretability", "local surrogate model", "explainability"],
  "data-cleaning-preprocessing": ["data cleaning", "missing value", "outlier detection", "feature engineering", "data preprocessing"],
  pytest: ["pytest", "fixtures", "parameterized test"],
  "junit-5": ["junit", "junit 5", "mockito"],
  "github-actions": ["github actions", "github workflow", "matrix build"],
  vercel: ["vercel", "preview deployment", "serverless function"],
  render: ["render.com", "render web service"],
  supabase: ["supabase", "row level security", "supabase auth"],
  "cloud-computing-fundamentals": ["iaas", "paas", "saas", "availability zone", "autoscaling", "cloud computing"],
  dbms: ["dbms", "normalization", "functional dependency", "acid", "mvcc", "write-ahead logging", "isolation level"],
  "design-patterns": ["design pattern", "singleton pattern", "factory pattern", "observer pattern", "strategy pattern", "decorator pattern"],
  "stackelberg-games": ["stackelberg game", "stackelberg equilibrium", "leader-follower game"],
  "stackelberg-security-games": ["stackelberg security game", "defender-attacker model", "coverage probability"],
  "cfr-counterfactual-regret-minimization": ["counterfactual regret minimization", "cfr algorithm", "extensive-form game"],
  "regret-minimization-online-learning": ["regret minimization", "online learning", "multiplicative weights", "bandit learning"],
  "stackelberg-security-games-with-learning": ["online stackelberg", "repeated security game"],
  "patrol-theory-security-resource-allocation": ["patrol planning", "security resource allocation"],
  "mathematical-modelling-optimization": ["mathematical modelling", "mathematical modeling", "decision variables", "objective function"],
  "research-experimental-methodology": ["ablation study", "baseline comparison", "experimental design", "reproducibility"],
  "resume-interview-defense": [],
};

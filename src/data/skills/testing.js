...
export const testingSkills = [
  ...
  },
  {
    ...
    why: "Added from the skills/subskills reference (pytest).",
    subskills: [
      { id: "pytest-test-fundamentals", name: "Test fundamentals", weight: 2, todos: [], knowledgePoints: ["test cases", "assertions", "expected behavior"] },
      { id: "pytest-pytest-structure", name: "pytest structure", weight: 2, todos: [], knowledgePoints: ["test files", "test functions", "test discovery"] },
      { id: "pytest-assertions", name: "Assertions", weight: 2, todos: [], knowledgePoints: ["assert", "expected exceptions", "approximate values"] },
      { id: "pytest-fixtures", name: "Fixtures", weight: 2, todos: [], knowledgePoints: ["fixture concept", "setup", "teardown", "fixture scope"] },
      { id: "pytest-parameterized-tests", name: "Parameterized tests", weight: 2, todos: [], knowledgePoints: ["multiple inputs", "edge cases", "data-driven testing"] },
      { id: "pytest-mocking", name: "Mocking", weight: 2, todos: [], knowledgePoints: ["mocks", "stubs", "dependency isolation"] },
      { id: "pytest-api-testing", name: "API testing", weight: 2, todos: [], knowledgePoints: ["endpoint tests", "request/response validation", "status codes"] },
      { id: "pytest-integration-testing", name: "Integration testing", weight: 2, todos: [], knowledgePoints: ["database integration", "external dependencies", "test environments"] },
      { id: "pytest-test-organization", name: "Test organization", weight: 2, todos: [], knowledgePoints: ["unit vs integration", "test naming", "test isolation"] },
      { id: "pytest-coverage", name: "Coverage", weight: 2, todos: [], knowledgePoints: ["line coverage", "branch coverage", "coverage limitations"] },
    ],
  },
  {
    id: "junit-5",
    ...
    level: 10,
    preparednessTarget: 3,
    why: "Added from the skills/subskills reference (JUnit 5).",
    subskills: [
      { id: "junit-5-junit-fundamentals", name: "JUnit fundamentals", weight: 2, todos: [], knowledgePoints: ["test classes", "test methods", "assertions"] },
      { id: "junit-5-assertions", name: "Assertions", weight: 2, todos: [], knowledgePoints: ["assertEquals", "assertTrue", "assertThrows", "assertAll"] },
      { id: "junit-5-test-lifecycle", name: "Test lifecycle", weight: 2, todos: [], knowledgePoints: ["BeforeEach", "AfterEach", "BeforeAll", "AfterAll"] },
      { id: "junit-5-parameterized-tests", name: "Parameterized tests", weight: 2, todos: [], knowledgePoints: ["parameter sources", "repeated test cases", "edge cases"] },
      { id: "junit-5-mockito-awareness", name: "Mockito awareness", weight: 2, todos: [], knowledgePoints: ["mocks", "stubs", "verification", "dependency isolation"] },
      { id: "junit-5-spring-boot-testing", name: "Spring Boot testing", weight: 2, todos: [], knowledgePoints: ["controller tests", "service tests", "repository tests", "integration tests"] },
      { id: "junit-5-test-organization", name: "Test organization", weight: 2, todos: [], knowledgePoints: ["unit tests", "integration tests", "test naming", "test isolation"] },
      { id: "junit-5-coverage-and-quality", name: "Coverage and quality", weight: 2, todos: [], knowledgePoints: ["code coverage", "meaningful tests", "regression tests"] },
    ],
  },
];
